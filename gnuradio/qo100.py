...
class qo100(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._vfo0_scope_win = sip.wrapinstance(self.vfo0_scope.qwidget(), Qt.QWidget)
        ...
        self.rx_resampler = filter.rational_resampler_ccc(
                ...
                taps=[],
                fractional_bw=0)
        self.rx0_low_cutoff_setter = blocks.msg_pair_to_var(self.set_rx0_low_cutoff)
        self.rx0_high_cutoff_setter = blocks.msg_pair_to_var(self.set_rx0_high_cutoff)
        ...
        self.msg_connect((self.control, 'rx0_high_cutoff'), (self.rx0_high_cutoff_setter, 'inpair'))
        ...
        self.connect((self.vfo0_waterfall_add, 0), (self.qtgui_waterfall_sink_x_0, 0))
